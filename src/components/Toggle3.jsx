...
function Toogle3() {
  ...
  <div className='containerdiv container Regular shadow'>
    ...
    <h1 className="display-6 col-lg-2 ">¿Quién soy?</h1>
      <img src={foto} className="rounded float-right col-lg-7 Regular shadow " alt="..."></img>
    <p className="lead col-lg-2">¡Hola! Soy Adolfo. Estudié la carrera de programación Full Stack en Rolling Code, actualmente me inclino hacia el análisis de datos manejando lenguajes como Phyton, MySQL, así también herramientas como Excel y diferentes formas de visualización de datos. 
